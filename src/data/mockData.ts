...
export const initialProducts: Product[] = [
  { id: "p1", name: "Arroz Nacional de Chicualacuala (25kg)", code: "ARR-025", category: "Mercearia", supplier: "MozAlimentos Lda", costPrice: 850, salePrice: 1200, vatRate: 16, stock: 45, minStock: 10, emoji: "🍙" },
  { id: "p2", name: "Óleo Alimentar Maçaroca (5L)", code: "OLE-005", category: "Mercearia", supplier: "Indústrias de Moçambique", costPrice: 420, salePrice: 580, vatRate: 16, stock: 4, minStock: 8, emoji: "🧴" },
  { id: "p3", name: "Farinha de Milho Top Score (10kg)", code: "FAR-010", category: "Mercearia", supplier: "MiliMoçambique", costPrice: 380, salePrice: 520, vatRate: 16, stock: 35, minStock: 15, emoji: "🌾" },
  { id: "p4", name: "Cerveja Laurentina Preta (Garrafa 330ml)", code: "CER-LAU", category: "Bebidas", supplier: "CDM - Cervejas de Moçambique", costPrice: 55, salePrice: 85, vatRate: 16, stock: 120, minStock: 40, emoji: "🍺" },
  { id: "p5", name: "Cerveja 2M (Lata 330ml)", code: "CER-2M", category: "Bebidas", supplier: "CDM - Cervejas de Moçambique", costPrice: 50, salePrice: 75, vatRate: 16, stock: 180, minStock: 50, emoji: "🍻" },
  { id: "p6", name: "Sumo Santal Maçã (1L)", code: "SUM-SAN", category: "Bebidas", supplier: "Distribuidora Sul", costPrice: 90, salePrice: 140, vatRate: 16, stock: 3, minStock: 12, expiryDate: "2026-07-15", emoji: "🧃" },
  { id: "p7", name: "Carregador Rápido USB-C 20W", code: "ELE-CRG", category: "Eletrónicos", supplier: "Afritronics", costPrice: 200, salePrice: 450, vatRate: 16, stock: 15, minStock: 5, emoji: "🔌" },
  { id: "p8", name: "Smartphone Itel A58 Lite", code: "ELE-ITE", category: "Eletrónicos", supplier: "Afritronics", costPrice: 2800, salePrice: 3990, vatRate: 16, stock: 2, minStock: 3, emoji: "📱" },
  { id: "p9", name: "Cimento Limbo 42.5N (50kg)", code: "CON-CIM", category: "Construção", supplier: "Cimentos de Moçambique", costPrice: 580, salePrice: 710, vatRate: 16, stock: 80, minStock: 20, emoji: "🧱" },
  { id: "p10", name: "Camiseta Polo Premium Masculina", code: "VEST-POL", category: "Vestuário", supplier: "Têxteis de Maputo", costPrice: 450, salePrice: 950, vatRate: 16, stock: 22, minStock: 6, emoji: "👕" },
  { id: "p11", name: "Iogurte Danone Morango (Pote 500g)", code: "MER-IOG", category: "Mercearia", supplier: "MozAlimentos Lda", costPrice: 80, salePrice: 130, vatRate: 16, stock: 18, minStock: 10, expiryDate: "2026-06-28", emoji: "🍧" }
];
